const translations = {
  it: {
    "nav.company": "Chi siamo", "nav.services": "Servizi", "nav.sectors": "Settori", "nav.clients": "Clienti", "nav.presence": "Dove operiamo", "nav.contact": "Contatti",
    "hero.eyebrow": "Last mile · Trasporto · Deposito", "hero.title": "La logistica che porta avanti il tuo business.", "hero.copy": "Dall'hub alla destinazione finale: processi precisi, persone affidabili e una rete che cresce insieme ai nostri partner.", "hero.cta": "Parliamo del tuo progetto",
    ...
    "about.p2": "Fondata nel 2022, l'azienda ha conosciuto una crescita costante e oggi opera in oltre 10 province italiane, collaborando con importanti operatori del settore logistico e gestendo migliaia di spedizioni destinate ai clienti finali.",
    ...
    "stats.one.title": "Costruiamo il futuro", "stats.one.copy": "Oltre 4 anni di crescita costante.", "stats.two.title": "Pacchi consegnati", "stats.two.copy": "Un traguardo raggiunto nel solo ultimo anno.", "stats.three.title": "Province coperte", "stats.three.copy": "Una presenza in continua espansione sul territorio italiano.",
    "services.kicker": "Servizi", "services.title": "Un'azienda, tre competenze.", "services.intro": "Costruiamo ogni intervento sulle esigenze reali del flusso logistico, dal ritiro alla consegna finale.",
    ...
    "presence.kicker": "Dove operiamo", "presence.title": "Le province dove siamo presenti", "presence.listTitle": "Province dove operiamo",
  ...
  pt: {
    "nav.company": "Quem somos", "nav.services": "Serviços", "nav.sectors": "Setores", "nav.clients": "Clientes", "nav.presence": "Onde atuamos", "nav.contact": "Contato",
    "hero.eyebrow": "Última milha · Transporte · Armazenagem", "hero.title": "A logística que impulsiona o seu negócio.", "hero.copy": "Do hub ao destino final: processos precisos, pessoas confiáveis e uma rede que cresce junto com nossos parceiros.", "hero.cta": "Fale sobre seu projeto",
    ...
    "about.p2": "Fundada em 2022, a empresa cresceu de forma constante e hoje opera em mais de 10 províncias italianas, colaborando com importantes operadores logísticos e gerenciando milhares de remessas destinadas aos clientes finais.",
    ...
    "stats.one.title": "Construímos o futuro", "stats.one.copy": "Mais de 4 anos de crescimento constante.", "stats.two.title": "Pacotes entregues", "stats.two.copy": "Uma marca alcançada somente no último ano.", "stats.three.title": "Províncias atendidas", "stats.three.copy": "Uma presença em contínua expansão pelo território italiano.",
    "services.kicker": "Serviços", "services.title": "Uma empresa, três competências.", "services.intro": "Criamos cada operação de acordo com as necessidades reais do fluxo logístico, da coleta à entrega final.",
    ...
    "presence.kicker": "Onde atuamos", "presence.title": "As províncias onde estamos presentes", "presence.listTitle": "Províncias onde atuamos",
  ...
  en: {
    "nav.company": "About us", "nav.services": "Services", "nav.sectors": "Sectors", "nav.clients": "Clients", "nav.presence": "Where we operate", "nav.contact": "Contact",
    "hero.eyebrow": "Last mile · Transport · Storage", "hero.title": "Logistics that moves your business forward.", "hero.copy": "From hub to final destination: precise processes, reliable people and a network that grows with our partners.", "hero.cta": "Tell us about your project",
    ...
    "about.p2": "Founded in 2022, the company has grown steadily and now operates in more than 10 Italian provinces, working with leading logistics operators and managing thousands of shipments for end customers.",
    ...
    "stats.one.title": "Building the future", "stats.one.copy": "More than 4 years of steady growth.", "stats.two.title": "Packages delivered", "stats.two.copy": "A milestone achieved in the past year alone.", "stats.three.title": "Provinces covered", "stats.three.copy": "A presence that keeps expanding across Italy.",
    "services.kicker": "Services", "services.title": "One company, three capabilities.", "services.intro": "We build every operation around the real needs of the logistics flow, from pickup to final delivery.",
    ...
    "presence.kicker": "Where we operate", "presence.title": "The provinces where we are present", "presence.listTitle": "Provinces we operate in",
...
const seo = {
  it: ["Frascarelli Trasporti | Last mile e logistica", "Frascarelli Trasporti: last mile, trasporto, movimentazione e deposito merci in oltre 10 province italiane."],
  pt: ["Frascarelli Trasporti | Última milha e logística", "Última milha, transporte, movimentação e armazenagem em mais de 10 províncias italianas."],
  en: ["Frascarelli Trasporti | Last-mile delivery and logistics", "Last-mile delivery, transport, handling and storage across more than 10 Italian provinces."]
};
